...
<body>
	...
	<div class="container">
		<div class="well ">
			<ul>
				<li><a id="a-moderation-page"
					href="${pageContext.request.contextPath}/moderator/first.html"><h3>View
							All Users(Moderator's Home Page)</h3></a></li>
				<li><a id="a-admin-first-page"
					href="${pageContext.request.contextPath}/admin/first.html"><h3>Admin's
							Home Page</h3></a></li>
				<li><a id="a-admin-second-page"
					href="${pageContext.request.contextPath}/admin/second.html"><h3>Admin
							Second Page</h3></a></li>
			</ul>
		</div>
	</div>
