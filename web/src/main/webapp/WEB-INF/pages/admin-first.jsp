...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link
		...
		rel="stylesheet">
		<link href="${pageContext.request.contextPath}/themes/main.css"
			rel="stylesheet">
			<script
...
<body class="home">
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse" id="navbar">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="${pageContext.request.contextPath}/admin/first.html"
				...
				<li class="dropdown"><a href="#" title="Administration"
					class="dropdown-toggle" data-toggle="dropdown">Administration</a>

					<ul class="dropdown-menu">


						<li class=""><a href="/admin/users" title="View Users">View
								Users</a></li>

						<li class=""><a href="/admin/activeUsers"
							title="Current Users">Current Users</a></li>

						<li class=""><a href="/admin/reload" title="Reload Options">Reload
								Options</a></li>

						<li class=""><a href="/fileupload" title="Upload A File">Upload
								A File</a></li>
					</ul></li>
	...
	<div class="container" id="content">
		...
		<div class="row">
			...
			<ul class="glassList">
				<li><a
					href="${pageContext.request.contextPath}/admin/insert.html">Insert
						New User</a></li>
